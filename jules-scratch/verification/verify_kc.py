...
def run(playwright):
    ...
    page.screenshot(path="jules-scratch/verification/kc_dashboard.png")
    ...
    page.screenshot(path="jules-scratch/verification/kc_form_layout.png")
    ...
    page.screenshot(path="jules-scratch/verification/kc_form_filtered.png")
