...
outcome_df = pd.DataFrame({"name": ["Improved access to education", "Reduced carbon emissions"]})
...
reference_df = pd.DataFrame(
    {
        ...
        "url": [
            ...
            "http://example.com/usaid",
            "http://example.com/climate",
        ],
        "reference_type": ["Report", "Website", "Publication"],
        "summary": [
            "A report on global health initiatives.",
            "The official website of USAID.",
            "A publication on reducing carbon emissions.",
        ],
    }
)
