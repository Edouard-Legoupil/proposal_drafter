        ...
        try {
            ...
            if (id) {
                ...
                if (cardRes.ok) {
                    ...
                    let specificRequiredRole = "";
                    if (card.donor_id) specificRequiredRole = "knowledge manager donors";
                    else if (card.outcome_id) specificRequiredRole = "knowledge manager outcome";
