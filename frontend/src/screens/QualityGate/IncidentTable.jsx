...
export default function IncidentTable({
    ...
    return (
        <div className="incident-monitoring">
            <Box sx={{ mb: 4, mt: 4 }}>
                        ...
                        <TableRow>
                            ...
                            <TableCell>
                                <TableSortLabel
                                    ...
                                    onClick={() => onRequestSort('source_type')}
                                >
                                    Source
                                </TableSortLabel>
                            </TableCell>
                            <TableCell>
                                <TableSortLabel
                                    ...
                                    onClick={() => onRequestSort('section_name')}
                                >
                                    Section
                                </TableSortLabel>
                            </TableCell>
                            <TableCell>
                                <TableSortLabel
                                    ...
                                    onClick={() => onRequestSort('type_of_comment')}
                                >
                                    Type
                                </TableSortLabel>
                            </TableCell>
                            ...
                            <TableCell>
                                <TableSortLabel
                                    ...
                                    onClick={() => onRequestSort('reviewer_name')}
                                >
                                    Reviewer
                                </TableSortLabel>
                            </TableCell>
                            ...
                            <TableRow key={incident.id} hover>
                                ...
                                <TableCell align="center">
                                    ...
                                    <button
                                        ...
                                        onClick={() => onLoadAnalysis(incident.incident_id)}
