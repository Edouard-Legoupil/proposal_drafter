...
export function TeamMembershipManagement({ team }) {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      const [nextMembers, nextRequests, nextAssigned, nextRoles] = await Promise.all([memberPromise, requestPromise, rolePromise, availablePromise])
  ...
  }, [canApproveMembership, canManageTeamRoles, getAvailableRoles, getMembers, getPendingRequests, getTeamRoles, team?.id])
