...
#  Internal Modules
from backend.api import auth, proposals, session, documents, health, users, knowledge, metrics, reviews, proposals_meta
...
app.include_router(proposals_meta.router, prefix="/api", tags=["Proposals Metadata"])
