...
#  Internal Modules
from backend.api import auth, proposals, session, documents, health, users, knowledge, metrics, wizzard
...
app.include_router(wizzard.router, prefix="/api", tags=["Wizzard"])
