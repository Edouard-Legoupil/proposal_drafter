...
def create_default_proposal_rules() -> RuleSet:
    ...
    rule_set = RuleSet(name="Simplified Proposal Qualification Rules", template_type="proposal", version="v1")
...
def create_default_knowledge_card_rules() -> RuleSet:
    ...
    rule_set = RuleSet(
        name="Simplified Knowledge Card Qualification Rules", template_type="knowledge_card", version="v1"
    )
...
def get_rule_set_for_artifact(artifact_type: str) -> RuleSet:
    ...
    if artifact_type == "proposal":
        ...
        rule_set = RuleSet(
            name=f"Default {artifact_type} Qualification Rules", template_type=artifact_type, version="v1"
        )
        rule_set.add_rule(
            QualificationRule(
