...
@router.put("/sessions/{session_id}/end", response_model=Dict[str, str],
...
@router.post("/wizard/log/", response_model=WizardInteractionResponse,
...
@router.get("/users/{user_id}/interactions/", response_model=List[UserInteractionResponse],
...
async def get_user_interactions_endpoint(
    ...
    try:
        interactions = await get_user_interactions(
            db, user_id, limit, offset, start_date, end_date, interaction_type
        )
        return [
            UserInteractionResponse(
                interaction_id=interaction.interaction_id,
...
@router.get("/users/{user_id}/wizard-interactions/", response_model=List[WizardInteractionResponse],
...
@router.get("/users/{user_id}/journey-patterns/", response_model=List[UserJourneyPattern],
