...
class UserSession(Base):
    ...
    session_duration = Column(Interval, 
                             server_default=text("(ended_at - started_at)"),
                             nullable=True)
    ...
    wizard_interactions = relationship("WizardInteraction", back_populates="session",
                                      cascade="all, delete-orphan")
...
class UserInteraction(Base):
    ...
    wizard_interaction = relationship("WizardInteraction", back_populates="interaction",
...
class WizardInteraction(Base):
    ...
    interaction_id = Column(UUID(as_uuid=True), ForeignKey('user_interactions.interaction_id', 
    ...
    selected_category_id = Column(UUID(as_uuid=True), ForeignKey('wizard_categories.category_id', 
                                                               ondelete='SET NULL'), nullable=True)
    viewed_qa_item_id = Column(UUID(as_uuid=True), ForeignKey('wizard_qa_items.qa_item_id', 
                                                            ondelete='SET NULL'), nullable=True)
