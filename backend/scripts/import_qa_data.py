...
def import_qa_data(yaml_file):
    ...
    try:
        ...
        for category_data in data["categories"]:
            ...
            existing_category = db.query(QACategory).filter_by(name=category_data["name"]).first()  # noqa: E501
        ...
        for category_data in data["categories"]:
            ...
            for question_data in category_data["questions"]:
                ...
                existing_item = db.query(QAItem).filter_by(question=question_data["question"]).first()  # noqa: E501
        ...
        success_message = (
            f"Successfully imported {categories_created} categories " f"and {qa_items_created} Q&A items"
        )  # noqa: E501
...
def main():
    ...
    parser.add_argument(
        "--file",
        "-f",
        default="backend/data/initial_qa_content.yaml",
        help="Path to the YAML file containing Q&A data",  # noqa: E501
    )
