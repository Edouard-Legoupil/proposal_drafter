        ...
        try:
            ...
            if rule.evaluation_mode == "hard_blocker":
                ...
                if rule.rule_code == "PROPOSAL_NO_UNRESOLVED_P0":
                    unresolved_p0_count = self._simulate_metric_query(
                        artifact_type, artifact_id, "unresolved_p0_count"
                    )
                    ...
                    passed = self._compare_values(
                        metric_value, rule.comparator or "=", rule.threshold_numeric or 0
                    )
            ...
            return {
                ...
                "metric_value": self._simulate_metric_query(artifact_type, artifact_id, rule.metric_name) if rule.metric_name else None,
