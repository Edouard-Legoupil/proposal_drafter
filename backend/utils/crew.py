...
class ProposalCrew():
    ...
    agents_config = 'backend/utils/config/agents.yaml'
    tasks_config = 'backend/utils/config/tasks.yaml'
    ...
    def __init__(self):
        ...
        self.json_knowledge = JSONKnowledgeSource(
            file_paths=[
                os.path.join(os.path.dirname(__file__), "knowledge/combine_example.json")
            ]
        )
