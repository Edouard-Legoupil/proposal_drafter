...
- Assess alignment with IOM's mission and work
...
- Focus on actionable intelligence for UNHCR operations"""
    ...
    research_task = Task(
        description=instructions[link_type].format(topic=topic),
        agent=researcher,
        expected_output="A list of up to 5 relevant URLs with a one-sentence summary for each."
    )
