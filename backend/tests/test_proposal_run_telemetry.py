...
def test_proposal_run_telemetry_structure():
    ...
    # Log output metrics
    proposal_run_logger.log_output_metrics(run_id=run_id, sections_generated=5, words_generated=2500, pages_generated=3)

    # Complete the run
    proposal_run_logger.complete_run(run_id=run_id, total_latency_ms=5000, success=True)
...
def test_proposal_run_failure_logging():
    ...
    proposal_run_logger.log_agent_execution(run_id=run_id, agent_name="content_generator", stage_latency_ms=1500)
    ...
    proposal_run_logger.complete_run(run_id=run_id, total_latency_ms=2000, success=False)
...
def test_knowledge_card_telemetry_structure():
    ...
    # Log output metrics
    proposal_run_logger.log_output_metrics(run_id=run_id, sections_generated=3, words_generated=1800, pages_generated=2)

    # Complete the run
    proposal_run_logger.complete_run(run_id=run_id, total_latency_ms=6000, success=True)
